...
def main(): 
    ...
    print (" 2. Linear Feedback Shift Register .") 
    print ("")
    test_selection = ""
    while (1):
        test_selection = input("Selection > ").strip()
        number_observations = input("no. of observations > ").strip()
        ...
        # If user selects lfsr function,
            ...
            print ("Please select a number from 1,2.")
        exit()
